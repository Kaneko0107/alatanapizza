...
<s:form action="ProductSearchAction" id="productSearchAction">
		<select name="categoryId" class="h_pulldown">
			...
			<s:if test="categoryId == 2"><option value="2" selected="selected">Pizza</option></s:if>
			<s:if test="categoryId != 3"><option value="3">SideMenu</option></s:if>
			<s:if test="categoryId == 3"><option value="3" selected="selected">SideMenu</option></s:if>
			<s:if test="categoryId != 4"><option value="4">DrinkMenu</option></s:if>
			<s:if test="categoryId == 4"><option value="4" selected="selected">DrinkMenu</option></s:if>
	    </select>
