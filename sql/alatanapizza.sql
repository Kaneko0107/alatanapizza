...
INSERT INTO m_category(-- --------カテゴリーマスタテーブルへ-----------
	...
	"SeafoodMix",-- 商品名
	"しーふーどみっくす",-- 商品名かな
	"シーフードナンバー１！魚介の旨みたっぷり！人気の海の幸と、野菜のリッチなおいしさ！",
	2,-- カテゴリID
	2700, -- Mサイズ値段
    4000, -- Lサイズ値段
    0,
	...
	"CheeseAndCheese",-- 商品名
	"ちーずあんどちーず",-- 商品名かな
	"チーズナンバー１！トマトの甘味ととろーりチーズが相性抜群の１枚です！",
	2,-- カテゴリID
	2300, -- Mサイズ値段
    3400, -- Lサイズ値段
    0,
	...
	"EbimayoBacon",-- 商品名
	"えびまよべーこん",-- 商品名かな
	"ぷりぷりのエビと甘みのあるベーコンに、じゅわっととけたマヨネーズとチーズが最高！お子さまから大人まで愛されるこの味わいをぜひご堪能ください。",
	2,-- カテゴリID
	2500, -- Mサイズ値段
    3800, -- Lサイズ値段
    0,
	...
	"Mediterranean",-- 商品名
	"ちちゅうかいのめぐみ",-- 商品名かな
	"ずわい蟹の濃厚な香りとエビのぷりっとした食感が楽しめる、シーフード好きにはたまらない一枚。爽やかなチェリートマトとたっぷりふりかけたパルメザンチーズがより旨味を引き立てます。",
	2,-- カテゴリID
	2700, -- Mサイズ値段
    4000, -- Lサイズ値段
    0,
	...
	"BasilPizza",-- 商品名
	"ばじるぴざ",-- 商品名かな
	"オリーブオイルとガーリックの風味が本格的なバジルソース。バジルソースと酸味のあるクリームチーズが味を引き立てます。",
	2,-- カテゴリID
	2100, -- Mサイズ値段
    3000, -- Lサイズ値段
    0,
	...
	"TeriyakiPizza",-- 商品名
	"てりやきぴざ",-- 商品名かな
	"チキンにしみこんだテリヤキソースがたまらない！ALATANAの大定番ピザ。※のりは別添えです。",
	2,-- カテゴリID
	2000, -- Mサイズ値段
    3200, -- Lサイズ値段
    0,
	...
	"FriedChicken",-- 商品名
	"フライドチキン",-- 商品名かな
	"こだわりの骨なしチキンを使ったとっておきのメニュー。どれにしようか迷ったら、コレで決まり！ジューシーでクセになる味わいです。",
	3,-- カテゴリID
	0,
    0,
    520,-- 価格
	...
	"FriedPotato",-- 商品名
	"フライポテト",-- 商品名かな
	"皮つきのうまさ！外はカリッ、中はホックリ！お子様にも大人気です！口に運べば、バターの風味とポテトの旨みが広がります。",
	3,-- カテゴリID
	0,
    0,
    480,-- 価格
	...
	"CaesarSalad",-- 商品名
	"しーざーさらだ",-- 商品名かな
	"しゃきしゃきレタス・新鮮野菜と、スモークチキン＆クルトンが絶妙！",
	3,-- カテゴリID
	0,
    0,
    620,-- 価格
